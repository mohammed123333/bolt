...
export const insuranceCompanies = [
  ...
  'الشرق الأوسط للتأمين', 'شركة اليرموك للتأمين', 'المتحدة للتأمين', 'المؤسسة العامه للضمان الاجتماعي',
  'الاماراتية سكوب', 'رويال كير', 'فيلادلفيا للتامين', 'نقابة المحامين', 'البنك المركزي الاردني',
  'بنك الاسكان', 'جراسا للتأمين', 'المنارة للتأمين', 'الأردنية الفرنسية للتأمين', 'جامعة الاسراء',
  'شركة الكهرباء الوطنية', 'ميد فيز', 'امد نت', 'ميدكس', 'اميد سيرفس', 'الكهرباء الأردنية',
  'شركة الفوسفات الأردنية', 'شركة مصفاة البترول الأردنية', 'البنك التجاري الأردني', 'نقابة الاسنان',
  'بنك الأردن', 'القدس للتأمين', 'الأراضي المقدسة للتأمين', 'غلوب ميد', 'دلتا للتأمين',
  'نقابة الأطباء الأردنيين', 'شركة التأمين الأردنية', 'الشركة الاردنية الاماراتية للتأمين سكوب',
  'نيوتن', 'جامعة ال البيت', 'تأمين الشركة العالمية', 'الاتحاد العربي الدولي للتأمين', 'البوتاس',
  'المجموعة العربية الأردنية للتأمين', 'العربية الألمانية للتأمين', 'البنك العربي', 'النسر العربي للتأمين',
  'البركة للتكافل', 'المجموعة العربية الأوروبية للتأمين', 'الأردن الدولية للتأمين', 'نقابة المهندسين',
  'الأولى للتأمين', 'الشرق العربي للتأمين', 'المتوسط والخليج للتأمين-ميدغلف', 'الأمريكية للتأمين على الحياة-اليكو',
  'شركة التامين العامة العربية المساهمة المحدودة', 'شركة توليد الكهرباء', 'شركة كهرباء السمرا',
  'شركة كهرباء إربد', 'شركة الأردن الدولية للتأمين', 'شركة التأمين الإسلامية', 'شركة التأمين العربية',
  'جمعية الثقافة و التعليم الأرثذوكسية', 'شركة بوبا للتأمين', 'تأمين مدارس الإتحاد', 'تأمين مستشفى الإستشاري',
  'تأمين مستشفى الخالدي', 'تأمين مستشفى إبن الهيثم', 'توزيع الكهرباء -نات هيلث', 'جامعة الإسراء',
  'جامعة البلقاء التطبيقية', 'جامعة العلوم الإسلامية', 'جامعة اليرموك', 'اومني كير', 'أوبتما',
  'الوطنية لصناعة الكوابل والأسلاك', 'الملكية المتخصصة لإدارة التأمينات', 'المتضامنون لاداره النفقات الطبيه',
  'الشركة العربية لصناعة الاسمنت الابيض', 'الصندوق الوطني للضمان الاجتماعي', 'الجامعة الهاشمية',
  'الخدمات الطبية الفلسطينية', 'الاردنية لاعادة تمويل الرهن العقاري', 'الأقصى للتأمين',
  'الاستشارية الدولية لادارة النفقات وخدمات التأمين', 'تأمين المحترفون', 'الملكية الاردنية', 'سيجنا',
  'بنك الاهلي', 'هيلث برو', 'الكلية العلمية الاسلامية', 'شركة الكهرباء المركزية', 'البنك الاسلامي الدولي',
  'بنك الاستثمار العربي الاردني', 'ميد سيرفس -خارج نطاق الرد الالي للطبيب', 'مجموعة الخليج للتأمين',
  'صندوق التأمين الصحي', 'الشركة الهندية الاردنية للكيماويات', 'الجامعة العربية الاسلامية', 'ضمان ودائع',
  'مركز الطيف الطبي', 'شركة المستقبل للبرامج الطبية', 'شركة المشرق', 'شركة الصقر العربي',
  'الشركة العربية لادارة النفقات', 'صناديق التامين الصحي للشركات العاملة قي قطاع الكهرباء', 'الأونروا',
  'مهني ميد', 'الشركة الانتمائية', 'ميد كونكت', 'شركة الاسمدة اليابانية- نات هيلث',
  'ميناء حاويات العقبة -نات هيلث', 'العربية الاردنية للتامين -نات هيلث', 'قرية العقبة اللوجستية-نات هيلث',
  'شركة مياه العقبة -نات هيلث', 'الاتحاد العربي الدولي للتامين - نات هيلث', 'اكسا- نات هيلث',
  'سيسكو-نات هيلث', 'الاقبال للاستثمار-نات هيلث', 'شركة المدن الصناعية -نات هيلث',
  'فجر الاردنية المصرية -نات هيلث', 'مجموعة الاتصالات الاردنية - نات هيلث', 'الاسمنت الاردنية لافارج-نات هيلث',
  'نكست كير - نات هيلث', 'مجموعة الصايغ - نات هيلث', 'جامعة الزرقاء-نات هيلث', 'رعاية امني',
  'الخلائق', 'الانتقالية', 'العناية المهيمنة', 'شركة الكهرباء المساهمة', 'تأمين المتحدون',
  'الاولى المتخصصه', 'النادي الدولي', 'ميتلايف', 'بدون تأمين'
];
