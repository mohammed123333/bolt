...
export const insuranceCompanies = [
  "nat_health",
  "jordan_artists_union",
  "arab_insurance",
  "wataniya_insurance",
  "arab_guarantors",
  "middle_east_insurance",
  "yarmouk_insurance",
  "united_insurance",
  "social_security",
  "emirates_scope",
  ...
  "jordan_bar_association",
  "central_bank",
  "housing_bank",
  "grassa_insurance",
  "manara_insurance",
  "jordan_french_insurance",
  "al_israa_university",
  "national_electric_company",
  "med_visa",
  "amd_net",
  "medex",
  "amed_service",
  "jordanian_electricity",
  "jordan_phosphate",
  "jordan_refinery",
  "jordan_commercial_bank",
  "dental_association",
  "bank_of_jordan",
  "quds_insurance",
  "holy_land_insurance",
  "glob_med",
  "delta_insurance",
  "jordan_medical_association",
  "jordan_insurance",
  "jordan_emirates_scope",
  "newton",
  "al_albayt_university",
  "global_company_insurance",
  "arab_union_insurance",
  "potash",
  "jordan_arab_group_insurance",
  "german_arab_insurance",
  "arab_bank",
  "arab_eagle_insurance",
  "al_baraka_takaful",
  "euro_arab_insurance",
  "jordan_international_insurance",
  "engineers_association",
  "first_insurance",
  "arabia_insurance",
  "medgulf",
  "american_life_lico",
  "general_arab_insurance",
  "electricity_generation_company",
  "samra_electricity",
  "irbid_electricity",
  "jordan_international_insurance_company",
  "islamic_insurance",
  "arab_insurance_company",
  "orthodox_education_association",
  "bupa",
  "union_schools",
  "istishari_hospital",
  "khalidi_hospital",
  "ibn_haytham_hospital",
  "nat_health_distribution",
  "al_israa_university_duplicate",
  "balqa_university",
  "islamic_science_university",
  "yarmouk_university",
  "omni_care",
  "optima",
  "national_cables",
  "specialized_insurance_management",
  "solidarity_medical",
  "white_cement",
  "national_social_security",
  "hashimite_university",
  "palestinian_medical_services",
  "jordanian_mortgage_refinance",
  "aqsa_insurance",
  "international_consulting_insurance",
  "professionals_insurance",
  "royal_jordanian",
  "cigna",
  "ahli_bank",
  "health_pro",
  "islamic_scientific_college",
  "central_electricity",
  "islamic_international_bank",
  "arab_investment_bank",
  "med_service_outside",
  "gulf_insurance_group",
  "health_insurance_fund",
  "indian_jordanian_chemicals",
  "arab_islamic_university",
  "deposit_guarantee",
  "altayf_medical_center",
  "future_medical_programs",
  "almashreq",
  "arab_falcon",
  "arab_expenses_management",
  "electricity_sector_health_funds",
  "unrwa",
  "mahni_med",
  "intimacy_company",
  "med_connect",
  "japanese_fertilizers_nat_health",
  "aqaba_port_nat_health",
  "arab_jordanian_nat_health",
  "aqaba_logistics_nat_health",
  "aqaba_water_nat_health",
  "arab_union_nat_health",
  "axa_nat_health",
  "cisco_nat_health",
  "iqbal_investment_nat_health",
  "industrial_cities_nat_health",
  "fajr_egypt_nat_health",
  "orange_nat_health",
  "lafarge_nat_health",
  "nextcare_nat_health",
  "sayegh_group_nat_health",
  "zarqa_university_nat_health",
  "omni_care_plus",
  "khalaeq",
  "transition",
  "dominant_care",
  "shareholding_electricity",
  "united_insurance_company",
  "specialized_first",
  "international_club",
  "metlife"
];
