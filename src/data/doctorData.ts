...
export const insuranceCompanies = [
  ...
  'arabGeneralInsurance',
  'electricityGeneration',
  'samraElectricity',
  'irbidElectricity',
  'jordanInternationalInsurance2',
  'islamicInsurance',
  'arabicInsurance',
  'orthodoxCultureAssociation',
  'bupaInsurance',
  'unionSchoolsInsurance',
  ...
  'islamicScienceUniversity',
  'yarmoukUniversity',
  'omniCare',
  'optima',
  'nationalCables',
  'specializedInsuranceManagement',
  'medicalExpensesManagement',
  'arabCementCompany',
  'nationalSocialSecurityFund',
  'hashemiteUniversity',
  'palestineMedicalServices',
  'jordanRefinance',
  'alAqsaInsurance',
  ...
  'ahlyBank',
  'healthPro',
  'islamicScientificCollege',
  'centralElectricity',
  'islamicInternationalBank',
  'arabJordanianInvestmentBank',
  'medServiceOutsideScope',
  'gulfInsuranceGroup',
  'healthInsuranceFund',
  'indianJordanianChemicals',
  'arabIslamicUniversity',
  'guaranteeDeposits',
  'altifMedicalCenter',
  'futureMedicalSoftware',
  'alMashreqCompany',
  'alSaqarArab',
  'arabicExpenseManagement',
  'electricityCompaniesInsurance',
  'unRwa',
  'professionalMed',
  'affiliationCompany',
  'medConnect',
  'japaneseFertilizerNatHealth',
  'aqabaContainersNatHealth',
  'arabJordanNatHealth',
  'aqabaLogisticsNatHealth',
  'aqabaWaterNatHealth',
  'arabUnionNatHealth',
  'axaNatHealth',
  'ciscoNatHealth',
  'iqbalInvestmentNatHealth',
  'industrialCitiesNatHealth',
  'egyptJordanNatHealth',
  'jordanTelecomNatHealth',
  'lafargeNatHealth',
  'nextCareNatHealth',
  'alSayeghNatHealth',
