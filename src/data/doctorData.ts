...
export const insuranceCompanies = [
  'insurance.natHealth',
  'insurance.artistsSyndicate',
  'insurance.alArabInsurance',
  'insurance.alWataniaInsurance',
  'insurance.alDamenoon',
  'insurance.middleEastInsurance',
  'insurance.yarmoukInsurance',
  'insurance.mottahedaInsurance',
  'insurance.socialSecurity',
  'insurance.emiratiScope',
  'insurance.royalCare',
  'insurance.philadelphiaInsurance',
  'insurance.lawyersSyndicate',
  'insurance.centralBank',
  'insurance.housingBank',
  'insurance.jrasaInsurance',
  'insurance.manaraInsurance',
  'insurance.jordanianFrenchInsurance',
  'insurance.israUniversity',
  'insurance.nationalElectricity',
  'insurance.medFees',
  'insurance.amedNet',
  'insurance.medex',
  'insurance.amidService',
  'insurance.jordanElectricity',
  'insurance.phosphateCompany',
  'insurance.jordanOilRefinery',
  'insurance.commercialBankJordan',
  'insurance.dentistsSyndicate',
  'insurance.jordanBank',
  'insurance.alQudsInsurance',
  'insurance.holyLandInsurance',
  'insurance.globMed',
  'insurance.deltaInsurance',
  'insurance.jordanDoctorsSyndicate',
  'insurance.jordanInsuranceCompany',
  'insurance.jordanEmiratiScope',
  'insurance.newton',
  'insurance.alAlBaytUniversity',
  'insurance.globalCompanyInsurance',
  'insurance.arabUnionInsurance',
  'insurance.botas',
  'insurance.arabJordanInsuranceGroup',
  'insurance.arabGermanInsurance',
  'insurance.arabBank',
  'insurance.arabEagleInsurance',
  'insurance.alBarakaTakaful',
  'insurance.arabEuropeanInsurance',
  'insurance.jordanInternationalInsurance',
  'insurance.engineersSyndicate',
  'insurance.firstInsurance',
  'insurance.arabEastInsurance',
  'insurance.medGulfInsurance',
  'insurance.americanLifeInsurance',
  'insurance.publicArabInsuranceCompany',
  'insurance.electricityGenerationCompany',
  'insurance.samaraElectricity',
  'insurance.irbidElectricity',
  'insurance.jordanInternationalInsuranceCompany',
  'insurance.islamicInsuranceCompany',
  'insurance.arabInsuranceCompany',
  'insurance.orthodoxEducationAssociation',
  'insurance.bupaInsurance',
  'insurance.unionSchoolInsurance',
  'insurance.istishariHospitalInsurance',
  'insurance.khalidiHospitalInsurance',
  'insurance.ibnAlHaythamHospitalInsurance',
  'insurance.natHealthElectricityDistribution',
  'insurance.israUniversity',
  'insurance.balqaAppliedUniversity',
  'insurance.islamicSciencesUniversity',
  'insurance.yarmoukUniversity',
  'insurance.omniCare',
  'insurance.optima',
  'insurance.nationalCables',
  'insurance.royalInsuranceManagement',
  'insurance.medicalExpenses',
  'insurance.whiteCementCompany',
  'insurance.socialSecurityFund',
  'insurance.hashimiUniversity',
  'insurance.palestinianMedicalServices',
  'insurance.jordanMortgageRefinancing',
  'insurance.alAqsaInsurance',
  'insurance.internationalConsultancyInsurance',
  'insurance.professionalsInsurance',
  'insurance.jordanRoyalInsurance',
  'insurance.cigna',
  'insurance.ahliBank',
  'insurance.healthPro',
  'insurance.islamicScienceCollege',
  'insurance.centralElectricity',
  'insurance.islamicInternationalBank',
  'insurance.arabJordanInvestmentBank',
  'insurance.medServiceOutsideDoctor',
  'insurance.gulfInsuranceGroup',
  'insurance.healthInsuranceFund',
  'insurance.indianJordanChemicals',
  'insurance.arabIslamicUniversity',
  'insurance.depositGuarantee',
  'insurance.medicalSpectrumCenter',
  'insurance.futureMedicalPrograms',
  'insurance.alMashreqCompany',
  'insurance.alSaqrArab',
  'insurance.expenseManagementArab',
  'insurance.corporateHealthInsuranceElectricity',
  'insurance.unrwa',
  'insurance.professionalMed',
  'insurance.affiliationCompany',
  'insurance.medConnect',
  'insurance.japaneseFertilizersNatHealth',
  'insurance.aqabaPortNatHealth',
  'insurance.arabJordanInsuranceNatHealth',
  'insurance.aqabaLogisticsVillageNatHealth',
  'insurance.aqabaWaterNatHealth',
  'insurance.arabUnionNatHealth',
  'insurance.axaNatHealth',
  'insurance.ciscoNatHealth',
  'insurance.alIqbalInvestmentNatHealth',
  'insurance.industrialCitiesNatHealth',
  'insurance.jordanEgyptFajrNatHealth',
  'insurance.jordanTelecomGroupNatHealth',
  'insurance.lafargeJordanCementNatHealth',
  'insurance.nextCareNatHealth',
  'insurance.alsayeghGroupNatHealth',
  'insurance.zarqaUniversityNatHealth',
  'insurance.amniCare',
  'insurance.khalaeq',
  'insurance.transitional',
  'insurance.dominantCare',
  'insurance.contributedElectricityCompany',
  'insurance.unitedInsurance',
  'insurance.firstSpecialized',
  'insurance.internationalClub',
  'insurance.metlife',
