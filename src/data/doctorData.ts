...
export const insuranceCompanies = [
  ...
  t('artistsSyndicate'),
  t('alArabInsurance'),
  t('alWataniaInsurance'),
  t('alDamenoon'),
  t('middleEastInsurance'),
  t('yarmoukInsurance'),
  t('mottahedaInsurance'),
  t('socialSecurity'),
  t('emiratiScope'),
  t('royalCare'),
  t('philadelphiaInsurance'),
  t('lawyersSyndicate'),
  t('centralBank'),
  t('housingBank'),
  t('jrasaInsurance'),
  t('manaraInsurance'),
  t('jordanianFrenchInsurance'),
  t('israUniversity'),
  t('nationalElectricity'),
  t('medFees'),
  t('amedNet'),
  t('medex'),
  t('amidService'),
  ...
  t('globMed'),
  t('deltaInsurance'),
  t('jordanDoctorsSyndicate'),
  t('jordanInsuranceCompany'),
  t('jordanEmiratiScope'),
  t('newton'),
  t('alAlBaytUniversity'),
  t('globalCompanyInsurance'),
  t('arabUnionInsurance'),
  t('botas'),
  t('arabJordanInsuranceGroup'),
  t('arabGermanInsurance'),
  t('arabBank'),
  t('arabEagleInsurance'),
  t('alBarakaTakaful'),
  t('arabEuropeanInsurance'),
  t('jordanInternationalInsurance'),
  t('engineersSyndicate'),
  t('firstInsurance'),
  t('arabEastInsurance'),
  t('medGulfInsurance'),
  t('americanLifeInsurance'),
  t('publicArabInsuranceCompany'),
  t('electricityGenerationCompany'),
  t('samaraElectricity'),
  t('irbidElectricity'),
  t('jordanInternationalInsuranceCompany'),
  t('islamicInsuranceCompany'),
  t('arabInsuranceCompany'),
  t('orthodoxEducationAssociation'),
  t('bupaInsurance'),
  t('unionSchoolInsurance'),
  t('istishariHospitalInsurance'),
  t('khalidiHospitalInsurance'),
  t('ibnAlHaythamHospitalInsurance'),
  t('natHealthElectricityDistribution'),
  t('balqaAppliedUniversity'),
  t('islamicSciencesUniversity'),
  t('yarmoukUniversity'),
  t('omniCare'),
  t('optima'),
  t('nationalCables'),
  t('royalInsuranceManagement'),
  t('medicalExpenses'),
  t('whiteCementCompany'),
  t('socialSecurityFund'),
  t('hashimiUniversity'),
  t('palestinianMedicalServices'),
  t('jordanMortgageRefinancing'),
  t('alAqsaInsurance'),
  t('internationalConsultancyInsurance'),
  t('professionalsInsurance'),
  t('jordanRoyalInsurance'),
  t('cigna'),
  t('ahliBank'),
  t('healthPro'),
  t('islamicScienceCollege'),
  t('centralElectricity'),
  t('islamicInternationalBank'),
  t('arabJordanInvestmentBank'),
  t('medServiceOutsideDoctor'),
  t('gulfInsuranceGroup'),
  t('healthInsuranceFund'),
  t('indianJordanChemicals'),
  t('arabIslamicUniversity'),
  t('depositGuarantee'),
  t('medicalSpectrumCenter'),
  t('futureMedicalPrograms'),
  t('alMashreqCompany'),
  t('alSaqrArab'),
  t('expenseManagementArab'),
  t('corporateHealthInsuranceElectricity'),
  t('unrwa'),
  t('professionalMed'),
  t('affiliationCompany'),
  t('medConnect'),
  t('japaneseFertilizersNatHealth'),
  t('aqabaPortNatHealth'),
  t('arabJordanInsuranceNatHealth'),
  t('aqabaLogisticsVillageNatHealth'),
  t('aqabaWaterNatHealth'),
  t('arabUnionNatHealth'),
  t('axaNatHealth'),
  t('ciscoNatHealth'),
  t('alIqbalInvestmentNatHealth'),
  t('industrialCitiesNatHealth'),
  t('jordanEgyptFajrNatHealth'),
  t('jordanTelecomGroupNatHealth'),
  t('lafargeJordanCementNatHealth'),
  t('nextCareNatHealth'),
  t('alsayeghGroupNatHealth'),
  t('zarqaUniversityNatHealth'),
  t('amniCare'),
  t('khalaeq'),
  t('transitional'),
  t('dominantCare'),
  t('contributedElectricityCompany'),
  t('unitedInsurance'),
  t('firstSpecialized'),
  t('internationalClub'),
  t('metlife'),
