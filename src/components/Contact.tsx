        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="flex items-start space-x-4 space-x-reverse">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">زورنا</h4>
                <p className="text-gray-600">شارع الملك حسين 123<br />عمان، الأردن 11181</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 space-x-reverse">
              ...
              <div>
                ...
                <p className="text-gray-600">7654 321 6 962+<br />الطوارئ: 0000 119 6 962+</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 space-x-reverse">
              ...
              <div>
                ...
                <p className="text-gray-600">info@tibjo.com<br />appointments@tibjo.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 space-x-reverse">
              ...
              <div>
                ...
                <p className="text-gray-600">الأحد - الخميس: 8:00 ص - 6:00 م<br />الجمعة: 9:00 ص - 4:00 م<br />السبت: الطوارئ فقط</p>
              </div>
            </div>
          </div>
