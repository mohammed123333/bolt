...
<select
  ...
  className="min-w-[120px] max-w-[140px] px-3 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-gray-50"
>
  {countryCodes.map(country => (
    ...
    <input
      ...
      className="flex-1 px-4 py-3 rounded-lg border border-l-0 border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
