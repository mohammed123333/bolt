                ...
                <div>
                  ...
                  <div className="flex" dir="ltr">
                    <select
                      ...
                      className="w-25 px-3 py-3 rounded-r-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-gray-50"
                    >
                    ...
                    <input
                      ...
                      className="w-full flex-1 px-4 py-3 rounded-l-lg border border-r-0 border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
