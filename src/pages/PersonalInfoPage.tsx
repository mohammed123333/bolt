                ...
                <div>
                  ...
                  <div className="flex" dir="ltr">
                    ...
                    <input
                      ...
                      className="w-20 flex-1 px-4 py-3 rounded-l-lg border border-r-0 border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
